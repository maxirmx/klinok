  ...
  children: [
    {
      ...
      children: leaves("well", ["Контрольный осмотр", "Чипирование", "Вакцинация", "Стрижка", "Манипуляции", "Транспортировка", "Повторный осмотр", "Взятие анализов", "Проведение исследования"]),
    },
    {
      id: "problem",
